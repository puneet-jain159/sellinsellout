...
Opening a pull request will trigger a[workflow](../.github/workflows/sellinsellout-run-tests-fs.yml) 
...
## Next Steps
After merging your pull request, subsequent runs of the feature engineering, model training and batch inference
...
* [Staging workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/staging-sellinsellout-model)
* [Prod workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/prod-sellinsellout-model)
