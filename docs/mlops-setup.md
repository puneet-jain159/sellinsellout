...
[ML Config](../sellinsellout/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore sellinsellout/databricks-resources/README.md
...
Follow the instructions in [sellinsellout/databricks-resources/README.md](../sellinsellout/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../sellinsellout/databricks-resources/README.md)  to propose, test, and deploy
